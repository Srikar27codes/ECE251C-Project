...
# global variables
PATH = Path("..\\ECG-Classification-Using-CNN-and-CWT\\dataset")
sampling_rate = 360

# for correct R-peak location (tolerance)
tol = 0.05
...
if __name__ == "__main__":
    # initialize the training records of ECG
    train_records = [
    ...
    train_data = [get_data(record) for record in train_records]
    ...
    test_data = [get_data(record) for record in test_records]
